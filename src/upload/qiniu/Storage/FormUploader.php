...
use wangzhan\upload\qiniu\Http\Client;
use wangzhan\upload\qiniu\Http\Error;
...
final class FormUploader
{
     ...
     */
    private static function crc32_data($data)
    {
     ...
     */
    private static function explodeUpToken($upToken)
    {
