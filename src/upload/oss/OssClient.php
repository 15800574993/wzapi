...
use wangzhan\upload\oss\Core\MimeTypes;
use wangzhan\upload\oss\Core\OssException;
use wangzhan\upload\oss\Http\RequestCore;
use wangzhan\upload\oss\Http\RequestCore_Exception;
use wangzhan\upload\oss\Http\ResponseCore;
use wangzhan\upload\oss\Model\CorsConfig;
use wangzhan\upload\oss\Model\CnameConfig;
use wangzhan\upload\oss\Model\LoggingConfig;
use wangzhan\upload\oss\Model\LiveChannelConfig;
use wangzhan\upload\oss\Model\LiveChannelInfo;
use wangzhan\upload\oss\Model\LiveChannelListInfo;
use wangzhan\upload\oss\Model\StorageCapacityConfig;
use wangzhan\upload\oss\Result\AclResult;
use wangzhan\upload\oss\Result\BodyResult;
use wangzhan\upload\oss\Result\GetCorsResult;
use wangzhan\upload\oss\Result\GetLifecycleResult;
use wangzhan\upload\oss\Result\GetLocationResult;
use wangzhan\upload\oss\Result\GetLoggingResult;
use wangzhan\upload\oss\Result\GetRefererResult;
use wangzhan\upload\oss\Result\GetStorageCapacityResult;
use wangzhan\upload\oss\Result\GetWebsiteResult;
use wangzhan\upload\oss\Result\GetCnameResult;
use wangzhan\upload\oss\Result\HeaderResult;
use wangzhan\upload\oss\Result\InitiateMultipartUploadResult;
use wangzhan\upload\oss\Result\ListBucketsResult;
use wangzhan\upload\oss\Result\ListMultipartUploadResult;
use wangzhan\upload\oss\Model\ListMultipartUploadInfo;
use wangzhan\upload\oss\Result\ListObjectsResult;
use wangzhan\upload\oss\Result\ListPartsResult;
use wangzhan\upload\oss\Result\PutSetDeleteResult;
use wangzhan\upload\oss\Result\DeleteObjectsResult;
use wangzhan\upload\oss\Result\CopyObjectResult;
use wangzhan\upload\oss\Result\CallbackResult;
use wangzhan\upload\oss\Result\ExistResult;
use wangzhan\upload\oss\Result\PutLiveChannelResult;
use wangzhan\upload\oss\Result\GetLiveChannelHistoryResult;
use wangzhan\upload\oss\Result\GetLiveChannelInfoResult;
use wangzhan\upload\oss\Result\GetLiveChannelStatusResult;
use wangzhan\upload\oss\Result\ListLiveChannelResult;
use wangzhan\upload\oss\Result\AppendResult;
use wangzhan\upload\oss\Model\ObjectListInfo;
use wangzhan\upload\oss\Result\SymlinkResult;
use wangzhan\upload\oss\Result\UploadPartResult;
use wangzhan\upload\oss\Model\BucketListInfo;
use wangzhan\upload\oss\Model\LifecycleConfig;
use wangzhan\upload\oss\Model\RefererConfig;
use wangzhan\upload\oss\Model\WebsiteConfig;
use wangzhan\upload\oss\Core\OssUtil;
use wangzhan\upload\oss\Model\ListPartsInfo;
   ...
   public function getLiveChannelHistory($bucket, $channelName, $options = NULL)
    ...
    private function auth($options)
    {
        ...
        if ($this->connectTimeout !== 0) {
         ...
         // dump($request->send_request());exit;
        try {
