 ...
 * Time: 下午2:09
 */
namespace wangzhan\pay\Ali\Buildermodel;
...
class AlipayTradePrecreateContentBuilder extends ContentBuilder
{
    ...
    public function setDisablePayChinnels($value)
    {
        $this->disable_pay_channels = $value;
        $this->bizParas['disable_pay_channels'] = $value;
    }
    ...
    public function setNotifyUrl($notifyUrl)
    {
        ...
        $this->bizParas['notify_url'] = $notifyUrl;
    }
